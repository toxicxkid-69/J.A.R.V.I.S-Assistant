...
# JARVIS IS A NORMAL BOT IT CAN DO YOUR BASIC TASKS LIKE OPENING APPS, SEARCHING ON GOOGLE, YOUTUBE, WIKIPEDIA, SETTING ALARMS, SENDING EMAILS, ETC. SO DON'T EXPECT MUCH FROM THIS BOT.
